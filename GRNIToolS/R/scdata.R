#' @title SCdata of mESC from single cell transcriptome of cell reprogramming process derived from Fluidigm C1 platform
#' @description This scdata contains six dataset that authors used to calculate. The raw data 'A', 'B' and 'InitialX' are used to calculate via algorithms. The 'TFlist' and 'namelist' are the name list of Transcription Factors (TFs) name and Target Genes name, respectively. And the 'HGS', High-throughput Golden Standard, is data help authors evaluate the results.
#' @usage data(scdata)
#' @format The scdata was constructed as 'list'
#' \describe{
