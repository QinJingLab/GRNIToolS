#' ARACNE algorithm (multiplicative model)
#' @description Default parameters for ARACNE algorithm for the reconstruction of gene interaction networks (multiplicative model).
...
#' @return A matrix which is the weighted adjacency matrix of the network inferred by aracne algorithm.
#' @export
#'
...
#' grn <- run_aracne.m(datexpr,gene)
run_aracne.m <- function(datexpr,gene,TF = NULL,file = NULL){
